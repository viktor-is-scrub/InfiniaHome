 ...
 * Using PhpStorm.
 * (c) 2016 xiurobert
 * Created on 5/16/2016 at 8:49 PM
 */
...
/**
 * Injects SQL into the database from a string
 * @param $string string SQL input
 * @param $db_conn mysqli DB Connection
 */
function inject_string_sql($string, $db_conn) {
    $string = remove_remarks($string);
    $string = split_sql_file($string, ';');

    $i = 1;
    foreach ($string as $sql) {
        echo $i++;
